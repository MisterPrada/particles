...
import { BlueNoiseGenerator } from '@/Utils/blue-noise-generation/src/BlueNoiseGenerator.js';
import { RendererState } from '@/Utils/shader-replacement/src/RendererState.js';
...
export class MotionBlurPass extends Pass {
	...
	_drawMesh( renderer, mesh, type, saveState ) {
		...
		if ( skip ) {
			...
			// fix order static meshes
			mesh.matrixWorld.elements[13] += 0.000001;
